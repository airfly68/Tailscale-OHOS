...
export const backendTaildriveListAsync: (request: string) => Promise<string>;
export const backendTaildriveStatAsync: (request: string) => Promise<string>;
export const backendTaildriveMutateAsync: (request: string) => Promise<string>;
export const backendTaildriveDownloadAsync: (request: string) => Promise<string>;
export const backendTaildriveUploadAsync: (request: string) => Promise<string>;
export const backendTaildriveTransferSnapshotAsync: () => Promise<string>;
export const backendTaildriveCancelAsync: () => Promise<string>;
